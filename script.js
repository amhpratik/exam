...

 {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "intestinal infection", correct: true },
      { text: "difillobotriosis", correct: false },
  ...
  },
  {
    question: "What milk-borne disease do you know?",
    answers: [
      { text: "foot-and-mouth disease", correct: true },
      { text: "botulism", correct: false },
      { text: "tetanus", correct: false },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Poisonings by impurities containing heavy metals’ salts", correct: true },
    ],
  },
  {
    question: "Find an example of food poisoning of non-microbial nature in the list below:",
    answers: [
      { text: "Solanine poisoning", correct: true },
      { text: "Staphylococcus intoxication", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Staphylococcus intoxication", correct: false },
      { text: "Cocaine intoxication", correct: false },
      { text: "Pesticides’ poisoning", correct: true },
      { text: "Botulism", correct: false },
      { text: "Tetanus", correct: false },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "the poisonous mushrooms", correct: false },
      { text: "fungi of the genus Aspergillus", correct: false },
      { text: "microorganisms of group Proteus", correct: true },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "toxic infection", correct: false },
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "analysis of menu layouts, questionnaire, laboratory", correct: true },
      { text: "balance and budget", correct: false },
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "high stickiness", correct: true },
      { text: "low digestibility", correct: false },
      { text: "high biological value", correct: false },
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "high salt content", correct: true },
      { text: "addition of sodium nitrite", correct: false },
    ],
  },
  {
    ...
    answers: [
      ...
      { text: 'collecting a food history and identifying a "suspect" product', correct: false },
      ...
      { text: "obtaining data from laboratory studies", correct: true },
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "72 - 80 days (+)", correct: true },
      { text: "82-100 days", correct: false },
    ],
  },
  {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "intestines of fish, rodents, pigs", correct: false },
    ],
  },
  {
    ...
    answers: [
      ...
      { text: "vegetables", correct: false },
      { text: "milk and dairy products", correct: true },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "cleaning, soaking, heat treatment, pickling", correct: true },
      { text: "drying, freezing, salting, smoking", correct: false },
    ],
  },
  {
    ...
    answers: [
      ...
      { text: "medical control over the health of workers in food enterprises", correct: true },
      ...
      { text: "sufficient supply of refrigeration equipment", correct: false },
    ],
  },
  {
